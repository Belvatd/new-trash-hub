...
const CustomerAccountPage = () => {
  ...
  const activeAddress =
    userData?.address && userData.address.length > 0
      ? userData.address[userData.indexAddressSelected || 0]
      : null
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-bold leading-tight">
              {userData?.fullName || user?.user_metadata?.full_name || "Customer"}
            </h1>
        ...
        <div className="flex items-center justify-between rounded-2xl bg-white p-4 shadow-sm border border-gray-100">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-gray-900">Tunas</p>
            </div>
          </div>
          <div className="flex items-baseline gap-0.5">
            <span className="text-2xl font-black text-brand-500">200</span>
      ...
      <div className="mt-6 px-6">
        ...
        <div className="flex flex-col rounded-2xl bg-white p-2 shadow-sm border border-gray-100 divide-y divide-gray-50">
          ...
          <div
            ...
            className="flex items-center gap-3 py-3 px-2 cursor-pointer hover:bg-gray-25 transition-colors"
          >
            <div className="text-gray-400">
              <MapPin size={18} />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-[10px] font-medium text-gray-400 leading-none">Alamat Utama</p>
              <p className="text-sm font-semibold text-gray-800 mt-1 truncate">
                {activeAddress
                  ? `${activeAddress.addressName} - ${activeAddress.fullAddress}`
                  : "Belum menentukan alamat utama"}
              </p>
            </div>
        ...
        <div className="flex flex-col rounded-2xl bg-white p-2 shadow-sm border border-gray-100 divide-y divide-gray-50">
          <div className="flex items-center justify-between py-3 px-2 cursor-pointer hover:bg-gray-25 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-gray-700">Tentang TrashHub</span>
            </div>
